...
const DashboardNetworkBackground: React.FC = () => {
...
export const CommitBarChart = ({
  ...
  // Show full monthly commit history (all-time). If empty, render a baseline.
    ...
    <div className={`${themeClass} w-full min-h-screen`}>
      ...
      <div className="min-h-screen flex flex-col font-['JetBrains_Mono',_monospace] bg-[#f6f7fb] dark:bg-[#0A0A0E] text-zinc-900 dark:text-slate-100 transition-colors duration-300 relative overflow-x-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage: `url("data:image/svg+xml;utf8,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilterLight'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.85' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilterLight)'/%3E%3C/svg%3E")`
          }}
        />
