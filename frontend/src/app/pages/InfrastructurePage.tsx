...
import { getInfrastructure, getTerraformCode, generateIac, type CostBreakdownItem } from '../../lib/api';

const INFRA_TF_PLACEHOLDER = '# Loading IaC from Velocis Predictor…';
      ...
      <div className="w-full h-screen flex flex-col overflow-hidden bg-zinc-50 dark:bg-[#010308] font-['Geist_Sans',_'Inter',_sans-serif] transition-colors duration-300 relative">
        ...
        <div className="flex-1 flex flex-row overflow-hidden relative z-10">
          ...
          >
            ...
            {/* Code Viewer ΓÇö scrollable within pane */}
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar">
              ...
              {/* ΓöÇΓöÇΓöÇ Insights Section ΓöÇΓöÇΓöÇ */}
              ...
              {/* ΓöÇΓöÇΓöÇ Change Impact Section ΓöÇΓöÇΓöÇ */}
              ...
              {/* ΓöÇΓöÇΓöÇ Confidence Checks Section ΓöÇΓöÇΓöÇ */}
              <div className="p-6">
